...
class RummyManager:
	...
	async def reset_game(self, game_logic: RummyGameLogic, room_connections: set):
	...
	async def start_game(self, websocket: WebSocket):
		...
		try:
			...
			# TODO: refactor what is passed into play_game()
	...
	# TODO: refactor what is passed into play_game()
	async def play_game(self, websocket: WebSocket, game_logic: RummyGameLogic, player: str,
		...
		try:
			while True:
				...
				try:
					# TODO refactor to use for rummy
